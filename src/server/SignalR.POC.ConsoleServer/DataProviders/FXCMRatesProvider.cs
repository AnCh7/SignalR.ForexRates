// =================================================
// File:
// SignalR.POC/SignalR.POC.ConsoleServer/FXCMRatesProvider.cs
// 
// Last updated:
// 2013-08-18 4:11 PM
// =================================================
...
{
	public class FXCMRatesProvider : IRatesProvider
	{
		private static ILoggerWrapper _wrapper;

		private static readonly Lazy<FXCMRatesProvider> Instance =
			new Lazy<FXCMRatesProvider>(
				() => new FXCMRatesProvider(GlobalHost.ConnectionManager.GetHubContext<FXCMRatesHub>().Clients));

		private readonly ICustomerInfoProvider _customerInfo;
		private readonly IFXCMRatesService _ratesService;
		...
		public static FXCMRatesProvider CurrentInstance
		{
			get
			{
