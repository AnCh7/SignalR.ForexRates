// =================================================
// File:
// SignalR.POC/SignalR.POC.ConsoleServer/FXCMRatesHub.cs
// 
// Last updated:
// 2013-08-18 4:10 PM
// =================================================
...
{
	[HubName("FXCMRatesHub")]
	public class FXCMRatesHub : Hub
	{
		private readonly FXCMRatesProvider _ratesProvider;

		public FXCMRatesHub() : this(FXCMRatesProvider.CurrentInstance)
		{}

		public FXCMRatesHub(FXCMRatesProvider ratesProvider)
		{
